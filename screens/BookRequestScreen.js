...
export default class BookRequestScreen extends Component{
  ...
  addRequest = async (bookName,reasonToRequest)=>{
    ...
    return Alert.alert("Money Requested Successfully")
 ...
 renderItem = ( {item, i} ) =>{
  ...
  render(){
    ...
    return(
      // Form screen
        <View style={{flex:1}}>
          <MyHeader title="Request Money" navigation ={this.props.navigation}/>
      ...
      :(
        ...
        <TextInput
          ...
          multiline
          numberOfLines ={8}
          placeholder={"information about the undergoing treatment with the cost and payment details"}
          onChangeText ={(text)=>{
              this.setState({
